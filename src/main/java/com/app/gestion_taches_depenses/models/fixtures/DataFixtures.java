...
//         tapha.setMotDePasse("12345678");
//         tapha.setSolde(15000); // 🔻 solde réduit
//         utilisateurRepository.save(tapha);

//         Utilisateur talla = new Utilisateur();
//         talla.setNom("Talla");
//         talla.setEmail("talla@tapha.sn");
//         talla.setMotDePasse("12345678");
//         talla.setSolde(100000); // solde normal
...
//             depense.setMontant(2000 + (i * 1000));
...
//             depense.setMontant(3000 + (i * 1500));
